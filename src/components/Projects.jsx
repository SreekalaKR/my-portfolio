  ...
  return (
    <section id="projects" className="px-6 md:px-16 py-20 pt-24">
      ...
      <p className="text-gray-400 text-center mt-2 max-w-xl mx-auto">
       A collection of projects demonstrating my skills in building scalable, responsive, and user-focused web applications.
      </p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-gray-900 rounded-xl overflow-hidden group hover:-translate-y-2 transition duration-300"
          >
            {/* IMAGE */}
